...
const WorkoutType = () => {
    ...
    const fetchWorkoutTypes = async () => {
        try {
            const response = await axios.get('https://fitness-tracker-app-uu0j.onrender.com/workout-types'); // Update this URL to your backend endpoint
    ...
    const addWorkoutType = async () => {
        try {
            const response = await axios.post('https://fitness-tracker-app-uu0j.onrender.com/workout-types', currentWorkoutType); // Update this URL to your backend endpoint
    ...
    const saveWorkoutType = async () => {
        try {
            const response = await axios.patch(`https://fitness-tracker-app-uu0j.onrender.com/workout-types/${currentWorkoutType._id}`, currentWorkoutType); // Update this URL to your backend endpoint
    ...
    const deleteWorkoutType = async (id) => {
        try {
            await axios.delete(`https://fitness-tracker-app-uu0j.onrender.com/workout-types/${id}`); // Update this URL to your backend endpoint
